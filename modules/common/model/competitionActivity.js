...
function CompetitionActivity() {
  this.table = 'competition_activity';
  baseModel.call(this);
  this.primary_key = 'id';

  this.insert_require = ['title','logo','create_time','url'];
  this.rules = [];
}

util.inherits(CompetitionActivity,baseModel);


CompetitionActivity.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
CompetitionActivity.prototype.addCompetitionActivity = function (data, callback) {
 ...
 * @returns {*}
 */
CompetitionActivity.prototype.addCompetitionActivity2 = function (connection, data, callback) {
...
module.exports = CompetitionActivity;