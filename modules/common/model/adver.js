...
function Adver() {
  ...
  this.insert_require = ['imagepath','location','create_time','type'];
  this.rules = [];
}

util.inherits(Adver,baseModel);


Adver.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
Adver.prototype.addAdver = function (data, callback) {
 ...
 * @returns {*}
 */
Adver.prototype.addAdver2 = function (connection, data, callback) {
