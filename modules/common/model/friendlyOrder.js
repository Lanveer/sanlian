...
/*友谊赛订单*/
function FriendlyOrder() {
  this.table = 'friendly_order';
  baseModel.call(this);
  this.primary_key = 'son_order_id';
  this.insert_require = ['order_id','user_id','court_id','start_time','end_time','price','create_time'];
  this.rules = [];
}

util.inherits(FriendlyOrder,baseModel);


FriendlyOrder.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
FriendlyOrder.prototype.addFriendlyOrder = function (data, callback) {
 ...
 * @returns {*}
 */
FriendlyOrder.prototype.addFriendlyOrder2 = function (connection, data, callback) {
