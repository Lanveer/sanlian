...
/*轮播图*/
function CompetitionPostsComment() {
  this.table = 'competition_posts_comment';
  baseModel.call(this);
  this.primary_key = 'id';
  this.insert_require = ['competition_id','competition_posts_id','create_time','nickname','content'];
  this.rules = [];
}

util.inherits(CompetitionPostsComment,baseModel);


CompetitionPostsComment.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
CompetitionPostsComment.prototype.addCompetitionPostsComment = function (data, callback) {
 ...
 * @returns {*}
 */
CompetitionPostsComment.prototype.addCompetitionPostsComment2 = function (connection, data, callback) {
...
module.exports = CompetitionPostsComment;