...
/*球场价格*/
function CloseOnce() {
  this.table = 'close_once';
  baseModel.call(this);
  this.primary_key = 'close_once_id';

  this.insert_require = ['once_id','time','create_time'];
  this.rules = [];
}

util.inherits(CloseOnce,baseModel);


CloseOnce.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
CloseOnce.prototype.addCloseOnce = function (data, callback) {
