...
function Promoted() {
  ...
  this.insert_require = ['name','content'];
  this.rules = [];
}

util.inherits(Promoted,baseModel);


Promoted.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
Promoted.prototype.addPromoted = function (data, callback) {
 ...
 * @returns {*}
 */
Promoted.prototype.addPromoted2 = function (connection, data, callback) {
