...
function ApplyRefund() {
  this.table = 'apply_refund';
  baseModel.call(this);
  this.primary_key = 'id';

  this.insert_require = ['order_id','user_id','create_time','reason'];
  this.rules = [];
}

util.inherits(ApplyRefund,baseModel);


ApplyRefund.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
ApplyRefund.prototype.addApplyRefund = function (data, callback) {
 ...
 * @returns {*}
 */
ApplyRefund.prototype.addApplyRefund2 = function (connection, data, callback) {
