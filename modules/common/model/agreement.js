...
function Agreement() {
  ...
  this.insert_require = ['title','content','create_time'];
  this.rules = [];
}

util.inherits(Agreement,baseModel);


Agreement.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
Agreement.prototype.addAgreement = function (data, callback) {
 ...
 * @returns {*}
 */
Agreement.prototype.addAgreement2 = function (connection, data, callback) {
