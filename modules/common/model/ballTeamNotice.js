...
/*球队公告*/
function BallTeamNotice() {
  this.table = 'ball_team_notice';
  baseModel.call(this);
  this.primary_key = 'id';

  this.insert_require = ['ball_team_id','user_id','create_time','content'];
  this.rules = [];
}

util.inherits(BallTeamNotice,baseModel);


BallTeamNotice.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
BallTeamNotice.prototype.addBallTeamNotice = function (data, callback) {
 ...
 * @returns {*}
 */
BallTeamNotice.prototype.addBallTeamNotice2 = function (connection, data, callback) {
