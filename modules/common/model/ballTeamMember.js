...
/*球队成员*/
function BallTeamMember() {
  this.table = 'ball_team_member';
  baseModel.call(this);
  this.primary_key = 'id';

  this.insert_require = ['ball_team_id','uid','create_time','type'];
  this.rules = [];
}

util.inherits(BallTeamMember,baseModel);


BallTeamMember.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
BallTeamMember.prototype.addBallTeamMember = function (data, callback) {
 ...
 * @returns {*}
 */
BallTeamMember.prototype.addBallTeamMember2 = function (connection, data, callback) {
