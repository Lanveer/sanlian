...
/*球队公告回复*/
function BallTeamNoticeComment() {
  this.table = 'ball_team_notice_comment';
  baseModel.call(this);
  this.primary_key = 'id';

  this.insert_require = ['ball_team_notice_id','user_id','create_time','content'];
  this.rules = [];
}

util.inherits(BallTeamNoticeComment,baseModel);


BallTeamNoticeComment.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
BallTeamNoticeComment.prototype.addBallTeamNoticeComment = function (data, callback) {
...
module.exports = BallTeamNoticeComment;