...
function Competition() {
  ...
  this.insert_require = ['title','img','create_time','start_time','type','address'];
  this.rules = [];
}

util.inherits(Competition,baseModel);


Competition.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
Competition.prototype.addCompetition = function (data, callback) {
 ...
 * @returns {*}
 */
Competition.prototype.addCompetition2 = function (connection, data, callback) {
