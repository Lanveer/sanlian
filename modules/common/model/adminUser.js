...
function AdminUser() {
  ...
  this.insert_require = ['loginname','password'];
  this.rules = [];
}

util.inherits(AdminUser,baseModel);


AdminUser.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
AdminUser.prototype.addAdminUser = function (data, callback) {
