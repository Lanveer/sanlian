...
function Category() {
  ...
  this.insert_require = ['name','content','create_time'];
  this.rules = [];
}
...
Category.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
Category.prototype.addCategory = function (data, callback) {
 ...
 * @returns {*}
 */
Category.prototype.addCategory2 = function (connection, data, callback) {
