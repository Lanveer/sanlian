...
function Emblem() {
  ...
  this.insert_require = ['title','logo','content','create_time','category_id'];
  this.rules = [];
}

util.inherits(Emblem,baseModel);


Emblem.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
Emblem.prototype.addEmblem = function (data, callback) {
 ...
 * @returns {*}
 */
Emblem.prototype.addEmblem2 = function (connection, data, callback) {
