...
/*轮播图*/
function CompetitionPosts() {
  this.table = 'competition_posts';
  baseModel.call(this);
  this.primary_key = 'id';

  this.insert_require = ['competition_id','title','content','create_time'];
  this.rules = [];
}

util.inherits(CompetitionPosts,baseModel);


CompetitionPosts.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
CompetitionPosts.prototype.addCompetitionPosts = function (data, callback) {
 ...
 * @returns {*}
 */
CompetitionPosts.prototype.addCompetitionPosts2 = function (connection, data, callback) {
...
module.exports = CompetitionPosts;