...
/*场馆*/
function BallTeamActivityUser() {
  this.table = 'ball_team_activity_user';
  baseModel.call(this);
  this.primary_key = 'id';

  this.insert_require = ['ball_team_activity_id','user_id','create_time'];
  this.rules = [];
}

util.inherits(BallTeamActivityUser,baseModel);


BallTeamActivityUser.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
BallTeamActivityUser.prototype.addBallTeamActivityUser = function (data, callback) {
 ...
 * @returns {*}
 */
BallTeamActivityUser.prototype.addBallTeamActivityUser2 = function (connection, data, callback) {
...
module.exports = BallTeamActivityUser;