...
function CompetitionRound() {
  this.table = 'competition_round';
  baseModel.call(this);
  this.primary_key = 'round_id';

  this.insert_require = ['competition_id','date','title','type','create_time'];
  this.rules = [];
}

util.inherits(CompetitionRound,baseModel);


CompetitionRound.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
CompetitionRound.prototype.addCompetitionRound = function (data, callback) {
 ...
 * @returns {*}
 */
CompetitionRound.prototype.addCompetitionRound2 = function (connection, data, callback) {
...
module.exports = CompetitionRound;