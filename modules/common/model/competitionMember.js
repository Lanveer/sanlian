...
/*轮播图*/
function CompetitionMember() {
  this.table = 'competition_member';
  baseModel.call(this);
  this.primary_key = 'id';

  this.insert_require = ['competition_id','ball_team_id','user_id','competition_ballteam_id','create_time'];
  this.rules = [];
}

util.inherits(CompetitionMember,baseModel);


CompetitionMember.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
CompetitionMember.prototype.addCompetitionMember = function (data, callback) {
 ...
 * @returns {*}
 */
CompetitionMember.prototype.addCompetitionMember2 = function (connection, data, callback) {
