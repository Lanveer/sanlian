...
function CompetitionBanner() {
  this.table = 'competition_banner';
  baseModel.call(this);
  this.primary_key = 'id';

  this.insert_require = ['competition_id','img','create_time','url'];
  this.rules = [];
}

util.inherits(CompetitionBanner,baseModel);


CompetitionBanner.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
CompetitionBanner.prototype.addCompetitionBanner = function (data, callback) {
 ...
 * @returns {*}
 */
CompetitionBanner.prototype.addCompetitionBanner2 = function (connection, data, callback) {
