...
util.inherits(CommodityBanner,baseModel);


CommodityBanner.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
CommodityBanner.prototype.addCommodityBanner = function (data, callback) {
 ...
 * @returns {*}
 */
CommodityBanner.prototype.addCommodityBanner2 = function (connection, data, callback) {
...
module.exports = CommodityBanner;