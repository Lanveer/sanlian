...
function CompetitionGroup() {
  this.table = 'competition_group';
  baseModel.call(this);
  this.primary_key = 'id';

  this.insert_require = ['competition_id','name','create_time'];
  this.rules = [];
}

util.inherits(CompetitionGroup,baseModel);


CompetitionGroup.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
CompetitionGroup.prototype.addCompetitionGroup = function (data, callback) {
 ...
 * @returns {*}
 */
CompetitionGroup.prototype.addCompetitionGroup2 = function (connection, data, callback) {
