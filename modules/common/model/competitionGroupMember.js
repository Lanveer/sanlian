...
/*轮播图*/
function CompetitionGroupMember() {
  this.table = 'competition_group_member';
  baseModel.call(this);
  this.primary_key = 'id';

  this.insert_require = ['competition_id','ball_team_id','competition_group_id','competition_ballteam_id','create_time'];
  this.rules = [];
}

util.inherits(CompetitionGroupMember,baseModel);


CompetitionGroupMember.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
CompetitionGroupMember.prototype.addCompetitionGroupMember = function (data, callback) {
 ...
 * @returns {*}
 */
CompetitionGroupMember.prototype.addCompetitionGroupMember2 = function (connection, data, callback) {
...
module.exports = CompetitionGroupMember;