...
function VipDesc() {
  ...
  this.insert_require = ['name','data'];
  this.rules = [];
}

util.inherits(VipDesc,baseModel);


VipDesc.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
VipDesc.prototype.addVipDesc = function (data, callback) {
