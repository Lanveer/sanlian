...
function Record() {
  ...
  this.insert_require = ['uid','create_time','type','remark','money'];
  this.rules = [];
}

util.inherits(Record,baseModel);


Record.prototype.search = function (queryParams,callback) {
  var self = this;
  var condition = {};
  var offset = 0;
  var limit = 5;
 ...
 * @returns {*}
 */
Record.prototype.addRecord = function (data, callback) {
 ...
 * @returns {*}
 */
Record.prototype.addRecord2 = function (connection, data, callback) {
